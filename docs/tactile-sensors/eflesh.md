...
**Mission Mimosa** is a robotics project focused on combining **vision, tactile sensing, and learning-based control** for robotic manipulation.

The eFlesh integration provides a customizable **magnetic tactile sensing layer**, enabling contact information to be incorporated into future visuo-tactile datasets and manipulation policies.
